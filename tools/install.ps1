...
{
	Write-Warning -Message "This script requires PowerShell 5+ to run, but you're currently running PowerShell $(if ($PSVersionTable -ne $null) { $PSVersionTable.PSVersion } else { "1.0" })!"
